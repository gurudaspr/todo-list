...
function App() {
  ...
  const [newDescrioption, setNewDescription] = useState("");
      ...
      <div className='todo-wrapper'>
        <div className='todo-input'>
          ...
          <div className='todo-input-item'>
            ...
            <input type="text" value={newDescrioption} onChange={(e) => setNewDescription(e.target.value)} placeholder="What's the task description?"></input>
          </div>
          <div className='todo-input-item'>
